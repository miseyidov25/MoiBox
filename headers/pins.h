...
// 
// RGB LED 1 (Puzzle 1) - Port D pins (GPIO3)
#define RGB_LED1_R  3u, 0u    // PD0, J2 Pin 9
#define RGB_LED1_G  3u, 1u    // PD1, J2 Pin 8
#define RGB_LED1_B  3u, 2u    // PD2, J2 Pin 7

// RGB LED 2 (Puzzle 2) - Port D pins continued (GPIO3)
#define RGB_LED2_R  3u, 3u    // PD3, J2 Pin 6
#define RGB_LED2_G  3u, 4u    // PD4, J2 Pin 5
#define RGB_LED2_B  3u, 5u    // PD5, J2 Pin 4

// RGB LED 3 (Puzzle 3) - Port C pins (GPIO2)
#define RGB_LED3_R  2u, 0u    // PC0, J2 Pin 3
#define RGB_LED3_G  2u, 1u    // PC1, J2 Pin 2
#define RGB_LED3_B  2u, 2u    // PC2, J2 Pin 1

// RGB LED 4 (Puzzle 4) - Port C pins continued (GPIO2)
#define RGB_LED4_R  2u, 3u    // PC3, J3 Pin 1
#define RGB_LED4_G  2u, 4u    // PC4, J3 Pin 2
#define RGB_LED4_B  2u, 5u    // PC5, J3 Pin 3

// RGB LED 5 (Puzzle 5) - Port E pins (GPIO4)
#define RGB_LED5_R  4u, 0u    // PE0, J3 Pin 4
#define RGB_LED5_G  4u, 1u    // PE1, J3 Pin 5
#define RGB_LED5_B  4u, 2u    // PE2, J3 Pin 6
...
//
#define LED_POWER   4u, 3u    // PE3, J4 Pin 14 (GPIO4)
#define LED_ERROR   1u, 0u    // PB0, J4 Pin 12 (GPIO1)
...
//
#define SWITCH_POWER    1u, 1u    // PB1, J3 Pin 7 (GPIO1, with pullup)
#define SWITCH_RESET    1u, 2u    // PB2, J3 Pin 8 (GPIO1, with pullup)
...
//
#define BUZZER_PIN     3u, 6u    // PD6, J4 Pin 16 (GPIO3, PWM capable)
...
//   * 0 # D
//
// Rows (Select which row to read) - Port A pins (GPIO0)
// Location: J5 Pmod header
//
#define KEYPAD_ROW1  0u, 0u   // PA0, J5 Pin 1
#define KEYPAD_ROW2  0u, 1u   // PA1, J5 Pin 2
#define KEYPAD_ROW3  0u, 2u   // PA2, J5 Pin 3
#define KEYPAD_ROW4  0u, 3u   // PA3, J5 Pin 4

// Columns (Read which columns are pressed) - Port A pins continued (GPIO0)
//
#define KEYPAD_COL1  0u, 4u   // PA4, J5 Pin 5
#define KEYPAD_COL2  0u, 5u   // PA5, J5 Pin 6
#define KEYPAD_COL3  0u, 12u  // PA12, J5 Pin 7
#define KEYPAD_COL4  0u, 13u  // PA13, J5 Pin 8
...
#define OLED_SDA_PORT          2u          // PTC (Port C, GPIO2)
#define OLED_SDA_PIN           7u
#define OLED_SCL_PORT          2u          // PTC (Port C, GPIO2)
...
#define BT_RX_PORT            0u          // PTA (Port A, GPIO0)
#define BT_RX_PIN             2u
#define BT_TX_PORT            0u          // PTA (Port A, GPIO0)
#define BT_TX_PIN             3u
